...
class ChatsView extends GetView<MessagesController> {
          ...
          return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return Column(
                  children: [
                    if(Get.find<MyAuthService>().myUser.value.id == controller.messages[index]['sender_partner_id'][0])...[
                      if(controller.messages[index]['name'].toString().split('|').first != "Automatic")
                    ...
                    if(Get.find<MyAuthService>().myUser.value.id != controller.travel['partner_id'][0])...[
                      if(receivedMessages.isNotEmpty && controller.validateMessage['price'] == null)
                        Align(
                            ...
                            child: ElevatedButton(
                                ...
                                onPressed: ()=> controller.shipperValidate(controller.messages[index]['id']),
                                child: Text('Accept price', style: Get.textTheme.headline2.merge(TextStyle(color: Colors.white, fontSize: 13)))
                            )
                        )
                    ]
                  ]
                                    ...
                                    children: [
                                      ...
                                      ElevatedButton(
                                          ...
                                          onPressed: ()=> {
                                            ...
                                            //Get.find<BookingsController>().getShipping(controller.card['id'])
                                          },
                                          child: Text('view invoice', style: Get.textTheme.headline2.merge(TextStyle(color: Colors.white, fontSize: 13)))
                                      )
                                    ]
                                  )
                                ]else...[
                                ...
                                children: [
                                                ...
                                                BlockButtonWidget(
                                                    onPressed: (){
                                                      ...
                                                      if(!controller.enableSend.value){
                                                        controller.priceController.text = "1.0";
                                                      }
                                  ...
                                  IconButton(
                                    ...
                                    onPressed: () {
                                      ...
                                      controller.chatTextController.text = "I propose...";
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text( DateFormat('d, MMM y | HH:mm').format(DateTime.parse(message['__last_update'])),
                        overflow: TextOverflow.fade,
  ...
  Widget buildBillSimulator(BuildContext context, var price){
    ...
    double tva = price * 0.2;
    double paid = price + tva;
    double service = paid * 0.1;
    double total = paid - service;

    return AlertDialog(
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),
      title: Center(
        child: Text("Bill Simulator", style: Get.textTheme.headline5.merge(TextStyle(color: buttonColor, letterSpacing: 2))),
      ),
      actions: [
        Align(
          ...
          child: TextButton(
            ...
            child: Text('Close', style: TextStyle(color: interfaceColor, fontSize: 14)),
          ),
        )
      ],
      content: SizedBox(
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ListTile(
                title: Text('Proposed price:', style: TextStyle(color: buttonColor, fontSize: 14)),
                trailing: RichText(
                  text: TextSpan(
                      children: [
              ...
              ListTile(
                title: Text('TVA 20%:', style: TextStyle(color: buttonColor, fontSize: 14)),
                trailing: RichText(
                  text: TextSpan(
                      children: [
              ...
              ListTile(
                title: Text('Total Paid:', style: TextStyle(color: buttonColor, fontSize: 14)),
                trailing: RichText(
                  text: TextSpan(
                      children: [
              ...
              ListTile(
                title: Text('Service fee:', style: TextStyle(color: buttonColor, fontSize: 14)),
                trailing: RichText(
                  text: TextSpan(
                      children: [
              ...
              ListTile(
                title: Text('Net to be received:', style: TextStyle(color: buttonColor, fontSize: 14)),
                trailing: RichText(
                  text: TextSpan(
                      children: [
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 10),
                  child: Text(
                      DateFormat('HH:mm | d, MMM y').format(DateTime.parse(message['__last_update'])),
                      overflow: TextOverflow.fade,
                      softWrap: false,
